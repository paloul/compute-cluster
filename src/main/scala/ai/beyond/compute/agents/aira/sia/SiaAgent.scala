...
object SiaAgent extends ShardedMessages {
  ...
  // Tell-based messages
  case class Start(id: String, resVoiFileName: String, faultVoiFileName: String) extends Message
...
trait SiaAgentJsonSupport extends SprayJsonSupport with DefaultJsonProtocol {
  ...
  implicit val startFormat = jsonFormat3(SiaAgent.Start)
...
class SiaAgent extends AiraAgent {
  ...
  def idle: Receive = {
    ...
    case Start(id, resVoiFileName, faultVoiFileName) =>
  ...
  /**
    ...
    * @param id
    * @param resVoiFileName
    * @param faultVoiFileName
    */
  def startProcessing(id: String, resVoiFileName: String, faultVoiFileName: String): Unit = {
