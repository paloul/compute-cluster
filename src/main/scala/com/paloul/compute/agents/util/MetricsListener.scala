...
import com.paloul.compute.logging.util.MetricsListenerLogging
...
/**
  ...
  */
class MetricsListener extends Actor with MetricsListenerLogging {
  ...
  /**
    * Logs Heap information. Reports only used heap memory in MB
    * @param nodeMetrics
    */
  ...
  /**
    * Logs CPU information. Reports average system load and num processors.
    * @param nodeMetrics
    */
